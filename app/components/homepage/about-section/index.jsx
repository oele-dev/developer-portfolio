export default function AboutSection({ locale }) {
  ...
  const body = isEs
    ...
    : [
        "I'm a software engineer with ten years in the Laravel ecosystem. I specialize in multi-tenant applications, Filament admin panels, serious API integrations (Google Workspace, QuickBooks, Hotmart, MikroTik, n8n) with reliable async work — queues/jobs on Redis, monitored with Horizon — and programmatic SEO at scale, paired with an AI-augmented workflow (Claude Code, Cursor) that lets me ship faster without skipping review.",
